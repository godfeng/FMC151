...
HD_PWD='D:/Document/FPGA Code/FMC151/FMC151.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log io_spi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source io_spi.tcl
