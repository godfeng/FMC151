...
HD_PWD='D:/Document/FPGA Code/FMC151/FMC151.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log io_spi.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source io_spi.tcl -notrace
